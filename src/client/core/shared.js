...
export const CHAT_CLOSED_VISIBLE_MESSAGES = 3;

export const MOVE_KEY_DELTAS = {
  ArrowUp: [0, -1],
  KeyZ: [0, -1],
  KeyW: [0, -1],
  ArrowDown: [0, 1],
...
export function hashPseudo(str) {
  let h = 0;
...
export function colorForPseudo(pseudo) {
...
export function normalizeAvatarIndex(value) {
...
export function base64ToTypedArray(b64, TypedArray) {
  const bin = atob(b64);
